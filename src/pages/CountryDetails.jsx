          ...
          <div className="min-h-[calc(100vh-260px)] ">
            {myCountry ? (
              <>
                ...
                {/* this div will contain all the spots information */}
                <div className="container md:p-0 p-4  mt-5 mb-5 md:mx-auto">
                  ...
                  <div className="flex flex-col items-center mb-10">
                    ...
                    <h2 className="text-3xl font-semibold">
                      Tourist Spots in {myCountry.countryName}
                    </h2>
                    <div className="">
                      <svg
                        width="370"
                  ...
                  {/* available spots on the current country */}
                  <div className="grid justify-items-center md:space-y-0 space-y-5 lg:grid-cols-4 md:gap-6 md:grid-cols-3 grid-cols-1">
                    {myCard.map((card) => (
                      <div
                        key={card._id}
                        className="w-[292px] lg:w-[292px] md:w-[230px] md:h-auto card bg-white shadow-lg rounded-lg overflow-hidden relative hover:shadow-2xl transition duration-300 ease-in-out "
                      >
                        <img
                        ...
                        />
                        {/* publisher avater */}
                        <div className="avatar  border rounded-full absolute  right-2 top-[140px]">
                        ...
                        <div className="p-4 card-body flex flex-col justify-between">
                          <div className="">
                            ...
                            <h2 className="text-lg font-semibold text-gray-800 mb-1">
                              {" "}
                              {card.location}, {card.countryName}{" "}
                            </h2>
                            <span> </span>
                          ...
                          <div className="mt-3 card-actions items-center flex justify-center">
                            <div className="flex ml-7 text-sm gap-6 w-full justify-between">
                              <div className="font-semibold p-1 w-full flex flex-col ">
