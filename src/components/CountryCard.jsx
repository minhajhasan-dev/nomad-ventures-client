  ...
  return (
    <div className="container max-w-7xl md:p-4 mx-auto mb-10">
      ...
      <div className="flex flex-col items-center mb-10">
        ...
        <h2 className="text-3xl font-semibold">Available Countries</h2>
        <div className="">
          <svg
            width="370"
            height="18"
      ...
      {loading ? (
        ...
        <div className="grid justify-items-center md:space-y-0 space-y-5 lg:grid-cols-4  md:gap-6 md:grid-cols-3 grid-cols-1">
          {countries.map((country) => (
            <div
              onClick={() => handleCountry(country.countryName)}
              key={country._id}
              className="hero cursor-pointer w-72 bg-cover bg-center rounded-xl shadow-lg hover:shadow-2xl transition duration-300 ease-in-out"
              style={{
                backgroundImage: `url(${
                  country.imageURL ||
            ...
            >
              ...
              <div className="hero-content text-center text-neutral-content">
                <div className="max-w-md">
                  <div className="mb-5 flex justify-center gap-2 text-3xl font-bold">
                    <FaMapLocationDot />
                    <h1>{country.countryName}</h1>
                  </div>

                  <p className="mb-5 text-white">{country.shortDescription}</p>
                </div>
              </div>
            </div>
          ))}
